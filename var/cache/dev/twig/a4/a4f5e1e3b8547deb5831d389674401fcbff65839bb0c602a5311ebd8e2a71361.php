...
class __TwigTemplate_397102d97f05082164eb40760753af2a402baa6878b7f4b2c98fe4de8e9835d8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Liste des ";
        // line 5
        echo twig_escape_filter($this->env, (isset($context["page_name"]) || array_key_exists("page_name", $context) ? $context["page_name"] : (function () { throw new RuntimeError('Variable "page_name" does not exist.', 5, $this->source); })()), "html", null, true);
        echo "</h1>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "
                <div class=\"col-12 col-md-4 col-lg-3\">
                    ...
                    <a href=\"";
            // line 15
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categories_single", ["slug" => twig_get_attribute($this->env, $this->source, $context["category"], "slug", [], "any", false, false, false, 15)]), "html", null, true);
            echo "\">
...
";
    ...
    {
        return array (  107 => 24,  94 => 17,  89 => 15,  84 => 12,  80 => 11,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        <div class=\"row\">
            ...
            {% for category in categories %}
                ...
                <div class=\"col-12 col-md-4 col-lg-3\">
                    ...
                    <a href=\"{{ path(\"categories_single\", {slug:category.slug}) }}\">
...
{% endblock %}
", "categories/index.html.twig", "C:\\wamp64\\www\\teddy_project\\templates\\categories\\index.html.twig");
    }
}
